...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.setMinimumSize(QtCore.QSize(1000, 410))
        MainWindow.setMaximumSize(QtCore.QSize(1000, 410))
        self.centralwidget = QtWidgets.QWidget(MainWindow)
        self.centralwidget.setObjectName("centralwidget")
        self.tableWidget = QtWidgets.QTableWidget(self.centralwidget)
        self.tableWidget.setGeometry(QtCore.QRect(193, 120, 598, 261))
        ...
        self.listWidget.setGeometry(QtCore.QRect(13, 120, 170, 231))
        ...
        self.listWidget_2.setGeometry(QtCore.QRect(800, 120, 191, 261))
        self.listWidget_2.setObjectName("listWidget_2")
        self.upper_table = QtWidgets.QTableWidget(self.centralwidget)
        self.upper_table.setGeometry(QtCore.QRect(13, 10, 911, 91))
        font = QtGui.QFont()
        ...
        self.create_button.setGeometry(QtCore.QRect(20, 360, 61, 23))
        self.create_button.setObjectName("create_button")
        self.delete_button = QtWidgets.QPushButton(self.centralwidget)
        self.delete_button.setGeometry(QtCore.QRect(100, 360, 61, 23))
        self.delete_button.setObjectName("delete_button")
        self.alley_change_button = QtWidgets.QPushButton(self.centralwidget)
        self.alley_change_button.setGeometry(QtCore.QRect(930, 10, 61, 93))
